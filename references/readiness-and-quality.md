...
Before recording evidence, capture delivery scope and relevant file/dependency fingerprints when observable. Do not claim a command, test, or user review occurred unless it was actually observed.
