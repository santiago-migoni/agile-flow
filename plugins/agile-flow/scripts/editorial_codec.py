...
TABLES = {
 ...
 'Decisions and collaboration agreements': [('decisions','id','reason|summary|decision|purpose','source','status|state','supersedes'), ('agreements','id','agreement|summary','source','status','supersedes')],
 ...
 'Scope changes': [('changes','at|date','change','source|reason','effect')],
 ...
 'Plan changes': [('changes','at|date','change','source|reason','impact')],
