...
Turn agreed needs into a proportionate, usable solution. During design, remain consultative: compare meaningful alternatives and explain effects on experience, cost, maintainability and operation before consolidating material choices. Refine screens, interactions, loading/empty/error states, accessibility and recovery in product-design.md. Own component, data, integration, deployment and trust-boundary choices in architecture.md.

Respect the user's explicit definitions and delegated choices. Resolve routine implementation details autonomously inside agreed boundaries. A user request to discuss backend and frontend calls for design, not an iteration or a complete stack selected as a package. Research evidence cannot establish the user's preference or approval.
